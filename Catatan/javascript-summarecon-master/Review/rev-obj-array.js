...
var arrProduct = [
    { name: "Noodle", price: 3500},
    { name: "Headphone", price: 4300000},
    { name: "Hoodie", price: 300000},
...
arrProduct.splice(
    1,2, 
    {...arrProduct[0], name: "Mie ayam", bisa: () => {console.log("Bisa terus")}}, 
    "String",
    23,
    true,
    (x) => {console.log("Nih bisa lagi, isinya x : " + x)}
)
